(() => {
  ...
  const quotationLanguagePath = (language) => {
    ...
    url.pathname = language === "ja" ? "/ja/resources/press-die-quotation/" : "/resources/press-die-quotation/";
